...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 32 | 🌐 Python | 📅 2026-04-13 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 26 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-08 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 14 | 🌐 Python | 📅 2026-04-08 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 17 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-10 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
...
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-04-10 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
* [algokit-client-generator-ts](https://github.com/algorandfoundation/algokit-client-generator-ts) ⭐ 5 | 🐛 9 | 🌐 TypeScript | 📅 2026-04-09 - Algorand AlgoKit Typed Client Generator for TypeScript.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 279 | 🌐 Go | 📅 2026-04-13 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 188 | 🐛 16 | 🌐 Go | 📅 2026-04-10 - The Algorand Golang SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 51 | 🌐 TypeScript | 📅 2026-04-12 - The Algorand JavaScript SDK & Examples.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 72 | 🐛 21 | 🌐 Java | 📅 2026-04-10 - The Algorand Java SDK.
...
* [pyteal](https://github.com/algorand/pyteal) ⭐ 289 | 🐛 61 | 🌐 Python | 📅 2026-03-12 - Algorand Smart Contracts in Python.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 9 | 🐛 13 | 🌐 Python | 📅 2026-04-01 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [algorand-mcp](https://github.com/GoPlausible/algorand-mcp) ⭐ 43 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-21 - Algorand Model Context Protocol (Server & Client) by GoPlausible.
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 5 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
...
* [Folks-Finance/algorand-js-sdk](https://github.com/Folks-Finance/folks-finance-js-sdk) ⭐ 41 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-10 - Official Folks Finance Algorand Protocol SDK.
...
* [vote-coin-demo](https://github.com/scholtz/vote-coin-demo) ⭐ 596 | 🐛 1 | 🌐 Vue | 📅 2025-09-08 - Decentralized message standard for on-chain voting on Algorand developed by @scholtz.
