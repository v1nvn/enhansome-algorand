...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 28 | 🌐 Python | 📅 2026-03-17 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
...
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 15 | 🌐 Python | 📅 2026-03-16 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 16 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-17 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
...
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-03-17 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
...
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-17 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [staketaxcsv](https://github.com/hodgerpodger/staketaxcsv) ⭐ 270 | 🐛 12 | 🌐 Python | 📅 2026-02-13 - Python backend for [stake.tax](https://stake.tax) that generates taxable transactions CSVs for Algorand and other Blockchains.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 269 | 🌐 Go | 📅 2026-03-17 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 189 | 🐛 8 | 🌐 Go | 📅 2026-03-16 - The Algorand Golang SDK.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 9 | 🐛 8 | 🌐 Python | 📅 2026-03-15 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-17 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 3 | 🐛 34 | 🌐 TypeScript | 📅 2026-03-17 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
