...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 24 | 🌐 Python | 📅 2026-03-19 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
...
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-19 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 269 | 🌐 Go | 📅 2026-03-20 - Algorand's official implementation in Go.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 40 | 🌐 TypeScript | 📅 2026-03-19 - The Algorand JavaScript SDK & Examples.
...
* [Liquid Auth](https://github.com/algorandfoundation/liquid-auth) ⭐ 32 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-19 - Self-hosted service to bind passkeys to crypto keypairs plus P2P signaling for secure peer connections.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-19 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 3 | 🐛 35 | 🌐 TypeScript | 📅 2026-03-20 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
