...
* [Algorand Protocol Specs](https://github.com/algorandfoundation/specs) ⭐ 73 | 🐛 22 | 🌐 TeX | 📅 2026-04-02 - Protocol-level specification documents for the Algorand platform.
...
* [algokit-cli](https://github.com/algorandfoundation/algokit-cli) ⭐ 191 | 🐛 30 | 🌐 Python | 📅 2026-03-31 - The Algorand AlgoKit CLI is the one-stop shop tool for developers building on the Algorand network.
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 23 | 🌐 Python | 📅 2026-04-14 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 26 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-13 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 17 | 🌐 Python | 📅 2026-04-13 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 17 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-14 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
* [algokit-core](https://github.com/algorandfoundation/algokit-core) ⭐ 15 | 🐛 39 | 🌐 Rust | 📅 2026-04-11 - Multi-language core primitives (Rust + FFI bindings) powering higher-level AlgoKit tooling (crypto, encoding, protocol logic).
...
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-04-14 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
...
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-13 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [AlgoWorld-Contracts](https://github.com/algoworldNFT/algoworld-contracts) ⭐ 28 | 🐛 10 | 🌐 Python | 📅 2026-04-08 - Collection of all smart contracts used by AlgoWorld, written in PyTeal.
...
* [QRCode Generator](https://github.com/emg110/algorand-qrcode) ⭐ 21 | 🐛 1 | 🌐 JavaScript | 📅 2024-09-09 - Uinversal QRCode generator module for Algorand ARC-26 URIs.
* [wen-tools](https://github.com/LoafPickleWW/wen-tools) ⭐ 21 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-07 - Bulk operations tool for Algorand.
...
* [algovanity](https://algovanity.com/) - Algorand Vanity Address Generator from [Ripe](https://github.com/Ripe/algovanity) ⭐ 16 | 🐛 0 | 🌐 Svelte | 📅 2025-01-25.
* [lazylora](https://github.com/aorumbayev/lazylora) ⭐ 13 | 🐛 5 | 🌐 Rust | 📅 2026-04-06 - Terminal UI for exploring Algorand blockchain.
* [TinyBar App](https://github.com/aorumbayev/tinybar) ⭐ 11 | 🐛 8 | 🌐 Python | 📅 2026-04-08 - A tiny macOS menu bar app for tracking ASA prices from TinyMan.
...
* [algorealm-ui](https://github.com/algorealm/algorealm-ui) ⭐ 3 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-31 - A web CLI Emulator version of algorealm cli game by @aorumbayev.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 266 | 🌐 Go | 📅 2026-04-14 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 188 | 🐛 16 | 🌐 Go | 📅 2026-04-13 - The Algorand Golang SDK.
...
* [py-algorand-sdk](https://github.com/algorand/py-algorand-sdk) ⭐ 277 | 🐛 12 | 🌐 Python | 📅 2026-04-13 - The Algorand Python SDK.
* [tinyman-py-sdk](https://github.com/tinymanorg/tinyman-py-sdk) ⭐ 117 | 🐛 7 | 🌐 Python | 📅 2026-03-30 - Tinyman Python SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-13 - The Algorand JavaScript SDK & Examples.
...
* [perawallet-connect](https://github.com/perawallet/connect) ⭐ 71 | 🐛 14 | 🌐 TypeScript | 📅 2026-03-23 - JavaScript SDK for integrating Pera Wallet to web applications.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-10 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 72 | 🐛 22 | 🌐 Java | 📅 2026-04-13 - The Algorand Java SDK.

#### .NET

* [dotnet-algorand-sdk](https://github.com/RileyGe/dotnet-algorand-sdk) ⭐ 41 | 🐛 4 | 🌐 C# | 📅 2023-05-24 - Algorand .NET SDK created by [@RileyGe](https://github.com/RileyGe).
...
* [dotnet-alogrand-sdk (2)](https://github.com/FrankSzendzielarz/dotnet-algorand-sdk) ⭐ 27 | 🐛 3 | 🌐 C# | 📅 2024-05-19 - Algorand .NET SDK maintained by [@FrankSzendzielarz](https://github.com/FrankSzendzielarz).
...
* [TEALScript](https://github.com/algorand-devrel/TEALScript) ⭐ 53 | 🐛 34 | 🌐 TypeScript | 📅 2025-12-17 - Enables Algorand smart contract development with native TypeScript syntax, tooling, and IDE support.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 9 | 🐛 14 | 🌐 Python | 📅 2026-04-14 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [Algorand Visual Studio Extension](https://github.com/FrankSzendzielarz/AlgorandVisualStudio) ⭐ 19 | 🐛 23 | 🌐 C# | 📅 2024-08-09 - Visual Studio extensions for C# TEAL compilation and Algorand Smart Contract development.
...
* [Algorand Sandbox](https://github.com/algorand/sandbox) ⭐ 240 | 🐛 11 | 🌐 Shell | 📅 2025-10-24 - Fast way to create and configure an Algorand development environment.
...
* [Liquid Auth](https://github.com/algorandfoundation/liquid-auth) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-25 - Self-hosted service to bind passkeys to crypto keypairs plus P2P signaling for secure peer connections.
* [Kibisis](https://github.com/kibis-is/web-extension) ⭐ 17 | 🐛 12 | 🌐 TypeScript | 📅 2025-08-10 - Open source Algorand wallet web extension built in React and TypeScript.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-13 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [rsagg](https://github.com/dragmz/rsagg) ⭐ 7 | 🐛 4 | 🌐 C | 📅 2026-03-30 - A Rust library for GPU accelerated Algorand 'vanity' address generation.
...
* [nodekit](https://github.com/algorandfoundation/nodekit) ⭐ 56 | 🐛 11 | 🌐 Go | 📅 2025-12-09 - Terminal user interface for running and managing Algorand nodes locally.
* [reti](https://github.com/algorandfoundation/reti) ⭐ 41 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-03 - Contracts, Node Daemon, and UI for Algorand 'The Reti' consensus incentives, enabling decentralized staking pools to broaden participation and enhance network security.
...
* [algorand-mcp](https://github.com/GoPlausible/algorand-mcp) ⭐ 44 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-21 - Algorand Model Context Protocol (Server & Client) by GoPlausible.
* [algorand-agent-skills](https://github.com/algorand-devrel/algorand-agent-skills) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2026-03-28 - Canonical collection of Agent Skills for AI-assisted development on Algorand by Algorand DevRel.
* [VibeKit](https://github.com/gabrielkuettel/vibekit) ⭐ 27 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-10 - CLI + MCP server that gives AI coding assistants the skills and tools to build on Algorand.
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 5 | 🐛 23 | 🌐 TypeScript | 📅 2026-04-13 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
...
* [Folks-Finance/algorand-js-sdk](https://github.com/Folks-Finance/folks-finance-js-sdk) ⭐ 41 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-13 - Official Folks Finance Algorand Protocol SDK.
...
* [ARC3](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0003.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-11 - Official Algorand Standard Asset Parameters Conventions for Fungible and Non-Fungible Tokens.
* [ARC4](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-11 - Application Binary Interface.
* [ARC32](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-11 - Application Specification.
* [ARC56](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-11 - Extended and improved Application Specification.
* [ARC69](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-11 - One of several Algorand Standard Asset Parameters Conventions.

## Contributing

Contributions welcome! Read the [contribution guidelines](https://github.com/awesome-algorand/awesome-algorand/blob/main/contributing.md) ⭐ 214 | 🐛 5 | 📅 2026-02-09 first.

Special thanks to everyone who forked or starred the repository ❤️

[![Stargazers repo roster for @awesome-algorand/awesome-algorand](https://reporoster.com/stars/dark/awesome-algorand/awesome-algorand)](https://github.com/awesome-algorand/awesome-algorand/stargazers) ⭐ 214 | 🐛 5 | 📅 2026-02-09

[![Forkers repo roster for @awesome-algorand/awesome-algorand](https://reporoster.com/forks/dark/awesome-algorand/awesome-algorand)](https://github.com/awesome-algorand/awesome-algorand/network/members) ⭐ 214 | 🐛 5 | 📅 2026-02-09
