...
* [algokit-cli](https://github.com/algorandfoundation/algokit-cli) ⭐ 191 | 🐛 31 | 🌐 Python | 📅 2026-03-27 - The Algorand AlgoKit CLI is the one-stop shop tool for developers building on the Algorand network.
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 27 | 🌐 Python | 📅 2026-03-31 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 25 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-30 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 17 | 🌐 Python | 📅 2026-03-30 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 16 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-30 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
...
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-03-30 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
...
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-30 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [AlgoWorld-Contracts](https://github.com/algoworldNFT/algoworld-contracts) ⭐ 28 | 🐛 9 | 🌐 Python | 📅 2026-03-26 - Collection of all smart contracts used by AlgoWorld, written in PyTeal.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 272 | 🌐 Go | 📅 2026-03-31 - Algorand's official implementation in Go.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-29 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 9 | 🐛 8 | 🌐 Python | 📅 2026-03-30 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-30 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [algorand-mcp](https://github.com/GoPlausible/algorand-mcp) ⭐ 41 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-21 - Algorand Model Context Protocol (Server & Client) by GoPlausible.
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 4 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-31 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
