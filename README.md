...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 24 | 🌐 Python | 📅 2026-04-10 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 25 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-08 - Algorand AlgoKit Utils for TypeScript.
...
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-10 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 279 | 🌐 Go | 📅 2026-04-12 - Algorand's official implementation in Go.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-11 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 5 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-12 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
