...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 26 | 🌐 Python | 📅 2026-03-06 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 25 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-07 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 17 | 🌐 Python | 📅 2026-03-07 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 16 | 🐛 14 | 🌐 TypeScript | 📅 2026-03-06 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
...
* [algokit-react-frontend-template](https://github.com/algorandfoundation/algokit-react-frontend-template) ⭐ 4 | 🐛 2 | 🌐 Jinja | 📅 2026-03-07 - Official AlgoKit React frontend template provides a production-ready baseline for developing and deploying React frontend applications with Algorand dependencies integrated. Also serves as a reference for template builders on implementing standalone algokit frontend templates.
...
* [AlgoWorld-Contracts](https://github.com/algoworldNFT/algoworld-contracts) ⭐ 28 | 🐛 10 | 🌐 Python | 📅 2026-03-02 - Collection of all smart contracts used by AlgoWorld, written in PyTeal.
...
* [lazylora](https://github.com/aorumbayev/lazylora) ⭐ 13 | 🐛 2 | 🌐 Rust | 📅 2026-03-02 - Terminal UI for exploring Algorand blockchain.
* [TinyBar App](https://github.com/aorumbayev/tinybar) ⭐ 12 | 🐛 8 | 🌐 Python | 📅 2026-03-02 - A tiny macOS menu bar app for tracking ASA prices from TinyMan.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,428 | 🐛 271 | 🌐 Go | 📅 2026-03-08 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 189 | 🐛 10 | 🌐 Go | 📅 2026-03-07 - The Algorand Golang SDK.
...
* [py-algorand-sdk](https://github.com/algorand/py-algorand-sdk) ⭐ 277 | 🐛 12 | 🌐 Python | 📅 2026-02-20 - The Algorand Python SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 69 | 🌐 TypeScript | 📅 2026-02-28 - The Algorand JavaScript SDK & Examples.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-06 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 72 | 🐛 32 | 🌐 Java | 📅 2026-03-07 - The Algorand Java SDK.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-07 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [VibeKit](https://github.com/gabrielkuettel/vibekit) ⭐ 21 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-08 - CLI + MCP server that gives AI coding assistants the skills and tools to build on Algorand.
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 3 | 🐛 44 | 🌐 TypeScript | 📅 2026-03-08 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
* [AlgoChat](https://github.com/CorvidLabs/ts-algochat) ⭐ 1 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-07 - Encrypted on-chain messaging protocol for Algorand, enabling AI agent-to-agent communication via transaction notes.
