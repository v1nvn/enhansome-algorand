...
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 16 | 🌐 Python | 📅 2026-02-15 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 16 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-15 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,424 | 🐛 270 | 🌐 Go | 📅 2026-02-15 - Algorand's official implementation in Go.
...
* [algorand-agent-skills](https://github.com/algorand-devrel/algorand-agent-skills) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2026-02-12 - Canonical collection of Agent Skills for AI-assisted development on Algorand by Algorand DevRel.
* [VibeKit](https://github.com/gabrielkuettel/vibekit) ⭐ 16 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-12 - CLI + MCP server that gives AI coding assistants the skills and tools to build on Algorand.
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 3 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-15 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
