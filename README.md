...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 280 | 🌐 Go | 📅 2026-04-10 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 188 | 🐛 15 | 🌐 Go | 📅 2026-04-09 - The Algorand Golang SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 49 | 🌐 TypeScript | 📅 2026-04-10 - The Algorand JavaScript SDK & Examples.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 72 | 🐛 20 | 🌐 Java | 📅 2026-04-09 - The Algorand Java SDK.
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 5 | 🐛 16 | 🌐 TypeScript | 📅 2026-04-10 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
...
* [ARC3](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0003.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-09 - Official Algorand Standard Asset Parameters Conventions for Fungible and Non-Fungible Tokens.
* [ARC4](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-09 - Application Binary Interface.
* [ARC32](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-09 - Application Specification.
* [ARC56](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-09 - Extended and improved Application Specification.
* [ARC69](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-09 - One of several Algorand Standard Asset Parameters Conventions.
