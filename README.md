...
* [Algorand Protocol Specs](https://github.com/algorandfoundation/specs) ⭐ 73 | 🐛 22 | 🌐 TeX | 📅 2026-05-04 - Protocol-level specification documents for the Algorand platform.
...
* [algokit-cli](https://github.com/algorandfoundation/algokit-cli) ⭐ 191 | 🐛 33 | 🌐 Python | 📅 2026-03-31 - The Algorand AlgoKit CLI is the one-stop shop tool for developers building on the Algorand network.
* [puya](https://github.com/algorandfoundation/puya) ⭐ 97 | 🐛 27 | 🌐 Python | 📅 2026-05-15 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
* [algokit-utils-ts](https://github.com/algorandfoundation/algokit-utils-ts) ⭐ 26 | 🐛 30 | 🌐 TypeScript | 📅 2026-05-14 - Algorand AlgoKit Utils for TypeScript.
* [algokit-utils-py](https://github.com/algorandfoundation/algokit-utils-py) ⭐ 19 | 🐛 23 | 🌐 Python | 📅 2026-05-14 - Algorand AlgoKit Utils for Python.
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 17 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-15 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
* [algokit-core](https://github.com/algorandfoundation/algokit-core) ⭐ 15 | 🐛 36 | 🌐 Rust | 📅 2026-05-13 - Multi-language core primitives (Rust + FFI bindings) powering higher-level AlgoKit tooling (crypto, encoding, protocol logic).
* [algokit-avm-vscode-debugger](https://github.com/algorandfoundation/algokit-avm-vscode-debugger) ⭐ 13 | 🐛 12 | 🌐 TypeScript | 📅 2026-03-23 - VSCode extension for line‑by‑line debugging of Algorand Python, TypeScript, TealScript and raw TEAL smart contracts via AVM traces.
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-05-14 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
* [algokit-client-generator-ts](https://github.com/algorandfoundation/algokit-client-generator-ts) ⭐ 5 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-14 - Algorand AlgoKit Typed Client Generator for TypeScript.
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-15 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [staketaxcsv](https://github.com/hodgerpodger/staketaxcsv) ⭐ 269 | 🐛 14 | 🌐 Python | 📅 2026-02-13 - Python backend for [stake.tax](https://stake.tax) that generates taxable transactions CSVs for Algorand and other Blockchains.
...
* [AlgoWorld-Contracts](https://github.com/algoworldNFT/algoworld-contracts) ⭐ 28 | 🐛 10 | 🌐 Python | 📅 2026-05-12 - Collection of all smart contracts used by AlgoWorld, written in PyTeal.
...
* [wen-tools](https://github.com/LoafPickleWW/wen-tools) ⭐ 22 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-16 - Bulk operations tool for Algorand.
...
* [lazylora](https://github.com/aorumbayev/lazylora) ⭐ 13 | 🐛 7 | 🌐 Rust | 📅 2026-04-27 - Terminal UI for exploring Algorand blockchain.
* [TinyBar App](https://github.com/aorumbayev/tinybar) ⭐ 11 | 🐛 7 | 🌐 Python | 📅 2026-05-14 - A tiny macOS menu bar app for tracking ASA prices from TinyMan.
...
* [algorealm-ui](https://github.com/algorealm/algorealm-ui) ⭐ 3 | 🐛 12 | 🌐 TypeScript | 📅 2026-05-14 - A web CLI Emulator version of algorealm cli game by @aorumbayev.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,428 | 🐛 266 | 🌐 Go | 📅 2026-05-16 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 188 | 🐛 28 | 🌐 Go | 📅 2026-05-14 - The Algorand Golang SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 298 | 🐛 65 | 🌐 TypeScript | 📅 2026-05-14 - The Algorand JavaScript SDK & Examples.
...
* [perawallet-connect](https://github.com/perawallet/connect) ⭐ 70 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-21 - JavaScript SDK for integrating Pera Wallet to web applications.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-15 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 73 | 🐛 34 | 🌐 Java | 📅 2026-05-14 - The Algorand Java SDK.
...
* [rust-algorand-sdk](https://github.com/manuelmauro/algonaut) ⭐ 68 | 🐛 29 | 🌐 Rust | 📅 2024-07-29 - Rust Algorand SDK.
...
* [d-asa](https://github.com/cusma/d-asa) ⭐ 10 | 🐛 8 | 🌐 Python | 📅 2026-05-11 - Debt Algorand Standard Application providing reference implementations and interfaces for tokenizing debt instruments (bonds, loans, commercial papers) that conform to ACTUS standards.
...
* [Liquid Auth](https://github.com/algorandfoundation/liquid-auth) ⭐ 33 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-16 - Self-hosted service to bind passkeys to crypto keypairs plus P2P signaling for secure peer connections.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 17 | 🌐 TypeScript | 📅 2026-05-14 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [reti](https://github.com/algorandfoundation/reti) ⭐ 42 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-03 - Contracts, Node Daemon, and UI for Algorand 'The Reti' consensus incentives, enabling decentralized staking pools to broaden participation and enhance network security.
...
* [algorand-mcp](https://github.com/GoPlausible/algorand-mcp) ⭐ 45 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-13 - Algorand Model Context Protocol (Server & Client) by GoPlausible.
* [algorand-agent-skills](https://github.com/algorand-devrel/algorand-agent-skills) ⭐ 31 | 🐛 1 | 🌐 Python | 📅 2026-05-13 - Canonical collection of Agent Skills for AI-assisted development on Algorand by Algorand DevRel.
...
* [Folks-Finance/algorand-js-sdk](https://github.com/Folks-Finance/folks-finance-js-sdk) ⭐ 41 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-14 - Official Folks Finance Algorand Protocol SDK.
...
* [ARC3](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0003.md) ⭐ 138 | 🐛 21 | 🌐 Python | 📅 2026-05-12 - Official Algorand Standard Asset Parameters Conventions for Fungible and Non-Fungible Tokens.
* [ARC4](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) ⭐ 138 | 🐛 21 | 🌐 Python | 📅 2026-05-12 - Application Binary Interface.
* [ARC32](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) ⭐ 138 | 🐛 21 | 🌐 Python | 📅 2026-05-12 - Application Specification.
* [ARC56](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) ⭐ 138 | 🐛 21 | 🌐 Python | 📅 2026-05-12 - Extended and improved Application Specification.
* [ARC69](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) ⭐ 138 | 🐛 21 | 🌐 Python | 📅 2026-05-12 - One of several Algorand Standard Asset Parameters Conventions.

## Contributing

Contributions welcome! Read the [contribution guidelines](https://github.com/awesome-algorand/awesome-algorand/blob/main/contributing.md) ⭐ 214 | 🐛 4 | 📅 2026-04-24 first.
