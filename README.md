...
* [puya](https://github.com/algorandfoundation/puya) ⭐ 96 | 🐛 24 | 🌐 Python | 📅 2026-04-09 - An official Python to TEAL compiler that allows you to write code to execute on the Algorand Virtual Machine (AVM) with Python syntax.
...
* [puya-ts](https://github.com/algorandfoundation/puya-ts) ⭐ 17 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-09 - An official TypeScript to TEAL compiler frontend, leveraging the core puya compiler, allows you to write code to execute on the Algorand Virtual Machine (AVM) with TypeScript syntax.
...
* [algorand-python-testing](https://github.com/algorandfoundation/algorand-python-testing) ⭐ 10 | 🐛 3 | 🌐 Python | 📅 2026-04-09 - A Python library for unit testing Algorand Python smart contracts without the need to interact with the Algorand Blockchain.
* [algokit-client-generator-ts](https://github.com/algorandfoundation/algokit-client-generator-ts) ⭐ 5 | 🐛 10 | 🌐 TypeScript | 📅 2026-04-08 - Algorand AlgoKit Typed Client Generator for TypeScript.
* [algorand-TypeScript-testing](https://github.com/algorandfoundation/algorand-TypeScript-testing) ⭐ 4 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-07 - A TypeScript library for unit testing Algorand smart contracts without the need to interact with the Algorand Blockchain.
...
* [go-algorand](https://github.com/algorand/go-algorand) ⭐ 1,426 | 🐛 282 | 🌐 Go | 📅 2026-04-09 - Algorand's official implementation in Go.
* [go-algorand-sdk](https://github.com/algorand/go-algorand-sdk) ⭐ 188 | 🐛 14 | 🌐 Go | 📅 2026-04-07 - The Algorand Golang SDK.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 47 | 🌐 TypeScript | 📅 2026-04-08 - The Algorand JavaScript SDK & Examples.
...
* [subtopia-js](https://github.com/subtopia-algo/subtopia-js) ⭐ 10 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-03 - Subtopia JavaScript SDK providing convenient interfaces to interact with Subtopia platform.
...
* [java-algorand-sdk](https://github.com/algorand/java-algorand-sdk) ⭐ 72 | 🐛 19 | 🌐 Java | 📅 2026-04-07 - The Algorand Java SDK.
...
* [use-wallet](https://github.com/txnlab/use-wallet) ⭐ 101 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-09 - React hooks for using Algorand compatible wallets with web applications. Developed by [txnlab](https://www.txnlab.dev/).
...
* [CorvidAgent](https://github.com/CorvidLabs/corvid-agent) ⭐ 5 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-09 - AI agent orchestration platform with on-chain messaging, persistent memory, and autonomous scheduling via Algorand.
...
* [ARC3](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0003.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-08 - Official Algorand Standard Asset Parameters Conventions for Fungible and Non-Fungible Tokens.
* [ARC4](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0004.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-08 - Application Binary Interface.
* [ARC32](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0032.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-08 - Application Specification.
* [ARC56](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0056.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-08 - Extended and improved Application Specification.
* [ARC69](https://github.com/algorandfoundation/ARCs/blob/main/ARCs/arc-0069.md) ⭐ 138 | 🐛 18 | 🌐 Python | 📅 2026-04-08 - One of several Algorand Standard Asset Parameters Conventions.
